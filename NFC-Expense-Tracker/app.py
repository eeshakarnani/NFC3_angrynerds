...
# Create and display the bar graph in the second column
        with col2:
            ...
            ax2.set_title("Expense Values", fontsize=12)
...
# Space for text under the visualizations
        ...
        - The pie chart represents the percentage distribution of expenses across different categories.
        - The bar chart shows the actual amount spent in each category.
        - The highest expenditure is on rent, while the least is in the 'Others' category.
        """)
